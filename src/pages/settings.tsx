              ...
              >
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      defaultChecked={notificationSettings.businessApplications}
                    />
                  </div>
                  <Separator style={{ borderColor: theme.colors.tertiary }} />
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      defaultChecked={notificationSettings.urgentAlerts}
                    />
                  </div>
                </CardContent>
              </Card>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p
                        ...
                        style={{ color: theme.colors.mutedText }}
                      >
                        Changes to system settings may affect application
                        security and performance. Please review all changes
