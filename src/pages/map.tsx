        ...
        <div className="mx-auto max-w-7xl w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-8">
            ...
            <div className="md:col-span-4 col-span-1 w-full">
              <div 
                className="bg-white rounded-lg shadow p-4 md:p-6 h-full"
                style={{ borderColor: colors.tertiary }}
              >
                <h3 
                ...
                <div className="space-y-4">
                  <div className="border-b pb-2" style={{ borderColor: colors.tertiary }}>
                    <p className="text-sm text-gray-600">Current View</p>
                    <p className="font-medium">{currentMapType.charAt(0).toUpperCase() + currentMapType.slice(1)} Map</p>
                  </div>
                  <div className="border-b pb-2" style={{ borderColor: colors.tertiary }}>
                    <p className="text-sm text-gray-600">User Polygons</p>
                    <p className="font-medium">{userPolygons.length} drawn</p>
                  </div>
                  <div className="border-b pb-2" style={{ borderColor: colors.tertiary }}>
                    <p className="text-sm text-gray-600">Biznest Areas</p>
                    <p className="font-medium">
                      {biznestPolygons.length} areas {biznestVisible ? '(visible)' : '(hidden)'}
                    </p>
                  </div>
                  <div className="border-b pb-2" style={{ borderColor: colors.tertiary }}>
                    <p className="text-sm text-gray-600">Flood Zones</p>
                    <p className="font-medium">
                      {floodPolygons.length} zones {floodVisible ? '(visible)' : '(hidden)'}
                    </p>
                  </div>
                  <div>
